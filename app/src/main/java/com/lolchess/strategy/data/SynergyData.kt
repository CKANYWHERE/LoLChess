...
class SynergyData {
    fun getBlaster() : Synergy{
        ...
        return Synergy("총잡이", R.drawable.trait_icon_blaster,description, option, level)
    }
    ...
    fun getSpacePirate() : Synergy{
        ...
        val level : List<Int> = listOf(2,4)
        return Synergy("우주해적",R.drawable.trait_icon_blaster,description, option, level)
    }

    fun getDarkStar(): Synergy{
        val description : String = "아군 챔피언이 죽으면 모든 아군 암흑의 별 챔피언의 공격력 및 주문력이 증가합니다."
        val option : List<String> = listOf("공격력 및 주문력 +12", " 공격력 및 주문력 +25", "공격력 및 주문력 +35", "공격력 및 주문력 +60")
        val level: List<Int> = listOf(2, 4, 6, 8)
        return Synergy("암흑의 별",R.drawable.trait_icon_blaster,description, option, level)
    }
    ...
    fun getProtector(): Synergy{
        ...
        return Synergy("수호자", R.drawable.trait_icon_blaster,description, option, level)
    }
    ...
    fun getStarGuardian(): Synergy{
        ...
        return Synergy("별 수호자", R.drawable.trait_icon_blaster,description, option, level)
    }
    ...
    fun getVanguard(): Synergy{
        ...
        val level: List<Int> = listOf(2, 4)
        return Synergy("선봉대", R.drawable.trait_icon_blaster,description, option, level)
    }
    ...
    fun getBladmaster(): Synergy{
        ...
        return Synergy("검사", R.drawable.trait_icon_blaster,description, option, level)
    }
    ...
    fun getCelestial(): Synergy{
        ...
        val level: List<Int> = listOf(2, 4, 6)
        return Synergy("천상", R.drawable.trait_icon_blaster,description, option, level)
    }
    ...
    fun getChrono(): Synergy{
        ...
        val level: List<Int> = listOf(2, 4, 6)
        return Synergy("시공간", R.drawable.trait_icon_blaster,description, option, level)
    }
   ...
   fun getSorcerer(): Synergy{
       val description : String = "모든 아군의 주문력이 증가합니다"
        ...
        val level: List<Int> = listOf(2, 4, 6, 8)
        return Synergy("마법사", R.drawable.trait_icon_blaster,description, option, level)
    }

    fun getSniper(): Synergy{
        val description : String = "저격수와 대상 사이에 놓인 칸 하나당 해당 저격수가 입히는 피해량이 증가합니다."
        val option : List<String> = listOf("한 칸당 피해량 12% 증가", "한 칸당 피해량 20% 증가")
        val level: List<Int> = listOf(2, 4)
        return Synergy("저격수", R.drawable.trait_icon_blaster,description, option, level)
    }
    ...
    fun getCybernetic(): Synergy{
        ...
        val level: List<Int> = listOf(3, 6)
        return Synergy("사이버네틱", R.drawable.trait_icon_blaster,description, option, level)
    }
    ...
    fun getBrawler(): Synergy{
        ...
        val level: List<Int> = listOf(2, 4)
        return Synergy("싸움꾼", R.drawable.trait_icon_blaster,description, option, level)
    }
    ...
    fun getRebel(): Synergy{
        ...
        val level: List<Int> = listOf(3, 6, 9)
        return Synergy("반군", R.drawable.trait_icon_blaster,description, option, level)
    }
    ...
    fun getBattlecast(): Synergy{
        ...
        val level: List<Int> = listOf(2, 4, 6)
        return Synergy("전투기계", R.drawable.trait_icon_blaster,description, option, level)
    }
    ...
    fun getDemolitionist(): Synergy{
        ...
        return Synergy("폭파광", R.drawable.trait_icon_blaster,description, option, level)
    }
    ...
    fun getInfiltrator(): Synergy{
        ...
        val level: List<Int> = listOf(2, 4, 6)
        return Synergy("잠입자", R.drawable.trait_icon_blaster,description, option, level)
    }
    ...
    fun getManaReaver(): Synergy{
        ...
        val option : List<String> = listOf("")
        val level: List<Int> = listOf(2)
        return Synergy("마나 약탈자", R.drawable.trait_icon_blaster,description, option, level)
    }
    ...
    fun getMechPilot(): Synergy{
        ...
        return Synergy("메카 파일럿", R.drawable.trait_icon_blaster,description, option, level)
    }
    ...
    fun getAstro(): Synergy{
        ...
        val option : List<String> = listOf("")
        val level: List<Int> = listOf(3)
        return Synergy("우주비행사", R.drawable.trait_icon_blaster,description, option, level)
    }

    fun getMystic(): Synergy{
        val description : String = "모든 아군이 마법 저항력을 얻습니다."
        val option : List<String> = listOf("마법 저항력 40", "마법 저항력 105")
        val level: List<Int> = listOf(2, 4)
        return Synergy("신비술사", R.drawable.trait_icon_blaster, description, option, level)
    }
    ...
    fun getMercenary(): Synergy{
        ...
        return Synergy("용병", R.drawable.trait_icon_blaster, description, option, level)
    }
    ...
    fun getStarship(): Synergy{
        ...
        val option : List<String> = listOf("")
        val level: List<Int> = listOf(1)
        return Synergy("우주선", R.drawable.trait_icon_blaster, description, option, level)
    }
    ...
    fun getParagon(): Synergy{
        ...
        val option : List<String> = listOf("")
        val level: List<Int> = listOf(1)
        return Synergy("인도자", R.drawable.trait_icon_blaster, description, option, level)
    }
