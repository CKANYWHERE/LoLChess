...
class SynergyData {
    fun getBlaster() : Synergy{
        ...
        return Synergy("총잡이","이미지경로",description, option, level)
    }
    ...
    fun getSpacePirate() : Synergy{
        ...
        val level : List<Int> = listOf(2,4)
        return Synergy("우주해적","이미지경로",description, option, level)
    }
    ...
    fun getDarkStar(): Synergy{
        ...
        return Synergy("암흑의 별", "이미지경로",description, option, level)
    }
    ...
    fun getProtector(): Synergy{
        ...
        return Synergy("수호자", "이미지경로",description, option, level)
    }
    ...
    fun getStarGuardian(): Synergy{
        ...
        return Synergy("별 수호자", "이미지경로",description, option, level)
    }
    ...
    fun getVanguard(): Synergy{
        ...
        val level: List<Int> = listOf(2, 4)
        return Synergy("선봉대", "이미지경로",description, option, level)
    }
    ...
    fun getBladmaster(): Synergy{
        ...
        return Synergy("검사", "이미지경로",description, option, level)
    }
    ...
    fun getCelestial(): Synergy{
        ...
        val level: List<Int> = listOf(2, 4, 6)
        return Synergy("천상", "이미지경로",description, option, level)
    }
    ...
    fun getChrono(): Synergy{
        ...
        val level: List<Int> = listOf(2, 4, 6)
        return Synergy("시공간", "이미지경로",description, option, level)
    }
   ...
   fun getSorcerer(): Synergy{
       val description : String = "모든 아군의 주문력이 증가합니다"
        ...
        val level: List<Int> = listOf(2, 4, 6, 8)
        return Synergy("마법사", "이미지경로",description, option, level)
    }
    ...
    fun getSniper(): Synergy{
        ...
        val level: List<Int> = listOf(2, 4)
        return Synergy("저격수", "이미지경로",description, option, level)
    }
    ...
    fun getCybernetic(): Synergy{
        ...
        val level: List<Int> = listOf(3, 6)
        return Synergy("사이버네틱", "이미지경로",description, option, level)
    }
    ...
    fun getBrawler(): Synergy{
        ...
        val level: List<Int> = listOf(2, 4)
        return Synergy("싸움꾼", "이미지경로",description, option, level)
    }
    ...
    fun getRebel(): Synergy{
        ...
        val level: List<Int> = listOf(3, 6, 9)
        return Synergy("반군", "이미지경로",description, option, level)
    }
    ...
    fun getBattlecast(): Synergy{
        ...
        val level: List<Int> = listOf(2, 4, 6)
        return Synergy("전투기계", "이미지경로",description, option, level)
    }
    ...
    fun getDemolitionist(): Synergy{
        ...
        return Synergy("폭파광", "이미지경로",description, option, level)
    }
    ...
    fun getInfiltrator(): Synergy{
        ...
        val level: List<Int> = listOf(2, 4, 6)
        return Synergy("잠입자", "이미지경로",description, option, level)
    }
    ...
    fun getManaReaver(): Synergy{
        ...
        val option : List<String> = listOf("")
        val level: List<Int> = listOf(2)
        return Synergy("마나 약탈자", "이미지경로",description, option, level)
    }
    ...
    fun getMechPilot(): Synergy{
        ...
        return Synergy("메카 파일럿", "이미지경로",description, option, level)
    }
    ...
    fun getAstro(): Synergy{
        ...
        val option : List<String> = listOf("")
        val level: List<Int> = listOf(3)
        return Synergy("우주비행사", "이미지경로",description, option, level)
    }
    ...
    fun getMystic(): Synergy{
        ...
        val level: List<Int> = listOf(2, 4)
        return Synergy("신비술사", "이미지경로", description, option, level)
    }
    ...
    fun getMercenary(): Synergy{
        ...
        return Synergy("용병", "이미지경로", description, option, level)
    }
    ...
    fun getStarship(): Synergy{
        ...
        val option : List<String> = listOf("")
        val level: List<Int> = listOf(1)
        return Synergy("우주선", "이미지경로", description, option, level)
    }
    ...
    fun getParagon(): Synergy{
        ...
        val option : List<String> = listOf("")
        val level: List<Int> = listOf(1)
        return Synergy("인도자", "이미지경로", description, option, level)
    }
